...
import { RiMicLine, RiStopFill, RiPlayFill, RiPauseLine, RiUploadCloud2Line } from 'react-icons/ri';
...
const AudioRecorder: React.FC<AudioRecorderProps> = ({ onRecordingComplete, onAdviceReceived }) => {
          ...
          <div className='flex flex-col items-center space-y-4'>
            ...
            <div className='flex space-x-4'>
              <button 
                ...
                className={`px-4 py-2 ${isUploading ? 'bg-gray-400' : 'bg-[#6629FF]'} text-[1.5vh] rounded-full text-white hover:scale-[1.04] transition-all flex items-center gap-2`}
              >
                {isUploading ? (
                  <>
              ...
              <button 
                ...
                disabled={isUploading}
                className={`px-4 py-2 ${isUploading ? 'bg-gray-400' : 'bg-[#FE9EC6]'} text-[1.5vh] rounded-full text-white hover:scale-[1.04] transition-all`}
              >
                Record New
              </button>
            </div>
